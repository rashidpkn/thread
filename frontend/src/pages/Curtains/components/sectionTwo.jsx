...
const SectionTwo = () => {
    return (
        <div className="flex flex-wrap justify-center gap-5 p-10 m-2 bg-gray-100 text-black">
        {/* // <div className='flex flex-col w-full h-full md:flex-row md:justify-evenly '> */}
            
            <div className="flex items-center justify-center w-24 h-24 border-2 bg-white border-[#cedaab] rounded-md img">
