  ...
  return (
    <div className='space-y-5'>
      <div className="p-5 w-full flex items-center justify-between gap-5">
        <button className='text-[#B68D40]' onClick={() => dispatch(setMenu(3))}>Back</button>
      ...
      <div className="flex justify-center gap-5">
        <button onClick={() => setSelector(1)} className={`${selector === 1 && 'text-[#B68D40]'}`} >Lining</button>
        <button onClick={() => setSelector(2)} className={`${selector === 2 && 'text-[#B68D40]'}`} >Pole/Track</button>
        <button onClick={() => setSelector(3)} className={`${selector === 3 && 'text-[#B68D40]'}`} >Accessories</button>
      </div>
