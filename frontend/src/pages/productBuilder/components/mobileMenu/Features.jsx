    ...
    return (
        <div className='space-y-5 h-96 overflow-y-scroll pb-10'>
            ...
            <div className="bg-[#624e27] flex justify-between items-center p-2 gap-2  rounded-lg text-white mx-5">
                <button onClick={() => setSelector(1)} className={`${selector === 1 && 'bg-[#b68d40]'}  w-[115px] h-[40px] rounded-md`} >Lining</button>
                <button onClick={() => setSelector(2)} className={`${selector === 2 && 'bg-[#b68d40]'}  w-[115px] h-[40px] rounded-md`} >Pole/Track</button>
