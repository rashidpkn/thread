  ...
  return (
    <div className='space-y-5 relative h-full'>
        ...
        <div className="flex flex-col gap-5 items-center">
            ...
            <input ref={Mobilename} onChange={e=>dispatch(setRoomName(e.target.value))} disabled={room=== 'Other Rooms' ? false : true} value={roomName} className='bg-[#122620]/30 h-12 pl-2 text-black' placeholder='Bedrooms' type="text" />
        </div>
