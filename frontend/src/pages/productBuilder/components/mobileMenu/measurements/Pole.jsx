            ...
            <div className="flex flex-col gap-3 items-center pt-10">
                ...
                <div className="flex  justify-center gap-5">
                    <div className="flex flex-col">
                        ...
                        <input  min={100} max={480} placeholder='100 CM to 305 CM'  onChange={e => {dispatch(setHeight(Number(e.target.value)));dispatch(setPrice())}} className='bg-[#122620]/30 h-12 pl-2 w-32 text-black placeholder:text-black' type="number" />
                    </div>
                    <div className="flex flex-col">
                        <label htmlFor="">Width CM</label>
                        <input  min={75} max={480} placeholder='75 CM to 480 CM' onChange={e => {dispatch(setWidth(Number(e.target.value)));dispatch(setPrice())}} className='bg-[#122620]/30 h-12 pl-2 w-32 text-black placeholder:text-black' type="number" />
                    </div>
